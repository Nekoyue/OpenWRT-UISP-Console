...
<<<<<<<< HEAD:target/linux/mediatek/files/drivers/net/phy/rtk/rtl8367c/rtl8367c_asicdrv_mib.c
...
========
		while (1) {
			...
			if (retVal != RT_ERR_OK)
				return retVal;
>>>>>>>> c6439b4f2b (can run):target/linux/uispconsole/files-4.19/drivers/net/phy/rtl83xx_api/rtl8367c_asicdrv_mib.c
